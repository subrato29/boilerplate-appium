...
import com.mobile.reports.ExtentManager;
...
public class Util {
    ...
    */
    ...
    public static String locator(String input) {
        String locator = null;
        try {
            if (DriverScript.mobileOSPlatform.toUpperCase().equals("IOS")) {
                locator = input.split(";")[1];
            } else {
                locator = input.split(";")[0];
            }
        } catch (Throwable e) {
            e.printStackTrace();
        }
